...
A lightweight, production-ready DAKboard widget that shows overall MTA status and the five most important active service alerts. It does not show train arrivals, bus arrivals, or line countdowns.
...
The widget normalizes the feed to:
